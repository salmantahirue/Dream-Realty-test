export const properties = [
  ...
  {
    id: 3,
    slug: "2211-lake-shore-dr-chicago-il",
    title: "Lakefront Luxury Penthouse",
    address: "2211 Lake Shore Dr",
    city: "Chicago",
    state: "IL",
    zipCode: "60614",
    price: 3200000,
    ...
    description:
      "Perched atop one of Chicago's most prestigious Lake Shore Drive addresses, this extraordinary penthouse offers an unparalleled living experience with panoramic views of Lake Michigan and the city skyline. Spanning 4,200 square feet, the residence features 5 bedrooms, 4 bathrooms, and a private rooftop terrace. The chef's kitchen is equipped with top-of-the-line Sub-Zero and Wolf appliances, custom cabinetry, and a climate-controlled wine cellar. The master suite includes a fireplace, dual walk-in closets, and a marble spa bathroom. Additional highlights include a private elevator, smart home technology throughout, and four dedicated parking spaces.",
    neighborhoodDescription:
      "Lincoln Park is one of Chicago's most desirable neighborhoods, offering the perfect blend of urban sophistication and natural beauty. Bordered by Lincoln Park — Chicago's largest park — and the beautiful Lake Michigan shoreline, residents enjoy world-class museums, the Lincoln Park Zoo, acclaimed restaurants, and boutique shopping along Armitage and Halsted Streets.",
    agent: {
      name: "Emily Chen",
      phone: "(312) 555-0223",
